...
def horizontal(no_progress,no_trailer,no_retriever,no_exclude):
  print( )
  print("--------------------------------------------------------------------------------------------------------")
  print("___HORIZONTAL HISTOGRAM___")
  print( )                                                                                  #Display Horizontal Histogram.
  print('Progress ',no_progress,':',"*"*no_progress)
  print('Trailer  ',no_trailer,':',"*"*no_trailer)
  print('Retriever',no_retriever,':',"*"*no_retriever)
...
#CODE________________________________________________________________________________________________________________________
...
while True:
    ...
    if choice=="y":
      ...
      horizontal(no_progress,no_trailer,no_retriever,no_exclude)
      break
    else:
